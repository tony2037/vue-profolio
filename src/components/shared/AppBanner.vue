...
<template>
	...
	>
		...
		<div class="w-full md:w-1/3 text-left">
			...
			>
				Hi, I'm Yu Chen (Tony) Liu
			</h1>
			<p
				class="font-general-medium mt-2 text-lg sm:text-xl  xl:text-2xl text-center sm:text-left leading-none text-gray-400"
			>
				A Software Engineer with 3+ years of industrial experience specilizing system programming.
			</p>
			<div class="flex justify-center sm:block">
				<a
					download="YuChenLiu-Tony_2024_summer.pdf"
					href="/files/YuChenLiu-Tony_2024_summer.pdf"
		...
		<div class="w-full md:w-2/3 text-right float-right">
			<img
				v-if="theme === 'light'"
				src="@/assets/images/ztexpenguin.svg"
				alt="Developer"
			/>
			<img
				v-else
