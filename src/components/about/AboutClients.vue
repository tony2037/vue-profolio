...
export default {
	...
	data: () => {
		return {
			clientsHeading: 'Some of Tech Companies I was in',
			clients: [
				{
					id: 1,
					title: 'Amazon',
					img: require('@/assets/images/companies/amazon_gray.png'),
				},
				{
					id: 2,
					title: 'Synology',
					img: require('@/assets/images/companies/synology_gray.png'),
				},
			],
		};
	},
